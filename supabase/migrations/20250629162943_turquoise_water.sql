/*
  # Add Reddit OAuth Configuration Functions

  1. New Functions
    - `get_active_reddit_config()` - Returns active Reddit OAuth configuration (client_id and redirect_uri)
    - `update_reddit_config()` - Updates or creates Reddit OAuth configuration (service role only)

  2. Security
    - Functions respect existing RLS policies
    - Update function requires service role permissions
*/
